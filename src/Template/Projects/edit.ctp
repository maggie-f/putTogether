            ...
            <div class="panel-body">
                <div id="dataProject">
                    <div class="input-group">
                        ...
                        value="<?= $project->created; ?>" readonly>
                    </div>
                    <div class="input-group">
                    ...
                    <input type="button" class="btn btn-violet btn-block" value="edit info" onclick="putTogether.openEditor();" readonly />
                </div>
                <div id="editProjecto" style="display: none;">
                    ...
                    <?= $this->Form->reset(__('Cancel'), ['class' => 'btn btn-default btn-block', "onclick" => "putTogether.closeEditor();"]); ?>
                    <?=  $this->Form->end(); ?>
                </div>
            </div>
        </div>
